 ...
 */
final class Version20251029180800 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE admin (id SERIAL NOT NULL, nom_admin VARCHAR(255) NOT NULL, prenom_admin VARCHAR(255) NOT NULL, mdp_admin VARCHAR(255) NOT NULL, droit_admin VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE bien (id SERIAL NOT NULL, proprietaire_id INT NOT NULL, adresse_bien VARCHAR(255) NOT NULL, ville_bien VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_45EDC38676C50E4A ON bien (proprietaire_id)');
        $this->addSql('CREATE TABLE categorie (id SERIAL NOT NULL, type VARCHAR(255) NOT NULL, libelle VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE chantier (id SERIAL NOT NULL, bien_id INT NOT NULL, inspecteur_id INT NOT NULL, ville_bien VARCHAR(255) NOT NULL, adresse_bien VARCHAR(255) NOT NULL, info_chantier VARCHAR(255) NOT NULL, statut_chantier VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE devis (id SERIAL NOT NULL, prix INT NOT NULL, duree VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE devis_type (id SERIAL NOT NULL, chantier_id INT NOT NULL, gestionnaire_id INT NOT NULL, prix INT NOT NULL, duree VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE entrepreneur (id SERIAL NOT NULL, ville_deploiement VARCHAR(255) NOT NULL, nom_entrepreneur VARCHAR(255) NOT NULL, prenom_entrepreneur VARCHAR(255) NOT NULL, email_entrepreneur VARCHAR(255) NOT NULL, tel_entrepreneur VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE gestionnaire (id SERIAL NOT NULL, nom_gestionnaire VARCHAR(255) NOT NULL, prenom_gestionnaire VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE inspecteur (id SERIAL NOT NULL, nom_imspecteur VARCHAR(255) NOT NULL, prenom_inspecteur VARCHAR(255) NOT NULL, email_inspecteur VARCHAR(255) NOT NULL, tel_inspecteur VARCHAR(255) NOT NULL, secteur_inspecteur VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE photo (id SERIAL NOT NULL, chantier_id INT NOT NULL, id_photo VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_14B78418D0C0049D ON photo (chantier_id)');
        $this->addSql('CREATE TABLE prestation (id SERIAL NOT NULL, categorie_id INT NOT NULL, libelle VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE proprietaire (id SERIAL NOT NULL, nom_proprietaire VARCHAR(255) NOT NULL, prenom_proprietaire VARCHAR(255) NOT NULL, email_proprietaire VARCHAR(255) NOT NULL, tel_proprietaire VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
