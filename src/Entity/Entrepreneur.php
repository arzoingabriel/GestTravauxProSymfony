...
class Entrepreneur
{
    ...
    private ?string $villeDeploiement = null;
    ...
    public function getVilleDeploiement(): ?string
    {
        return $this->villeDeploiement;
    }

    public function setVilleDeploiement(string $villeDeploiement): static
    {
