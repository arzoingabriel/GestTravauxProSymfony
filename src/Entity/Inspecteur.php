...
class Inspecteur
{
    ...
    private ?string $nomImspecteur = null;
    ...
    public function getNomImspecteur(): ?string
    {
        return $this->nomImspecteur;
    }

    public function setNomImspecteur(string $nomImspecteur): static
    {
        $this->nomImspecteur = $nomImspecteur;
